...
if __name__ == '__main__':
    ...
    for i_contrast, contrast in enumerate(contrast_levels):
        fr_tp1[i_contrast].append(M2_s2_pre[i_contrast].mean(axis=1))
        fr_tp2[i_contrast].append(M2_s2_post[i_contrast].mean(axis=1))
        FanoFactor_tp1[i_contrast].append(M2_s2_pre[i_contrast].var(axis=1) / M2_s2_pre[i_contrast].mean(axis=1)*(twindow[1]-twindow[0])/1000)
        FanoFactor_tp2[i_contrast].append(M2_s2_post[i_contrast].var(axis=1) / M2_s2_post[i_contrast].mean(axis=1)*(twindow[1]-twindow[0])/1000)
        nc_tp1 = np.corrcoef(M2_s2_pre[i_contrast])
        nc_tp2 = np.corrcoef(M2_s2_post[i_contrast])
    ...
    for i_contrast, contrast in enumerate(contrast_levels):
        ...
        decoding_tp1[i_contrast] = Decoding(M2_s1_pre[i_contrast], M2_s2_pre[i_contrast])
        decoding_tp2[i_contrast] = Decoding(M2_s1_post[i_contrast], M2_s2_post[i_contrast])

        params = [(M2_s2_pre[i_contrast], (twindow[1]- twindow[0])/1000),
                  (M2_s2_post[i_contrast], (twindow[1]- twindow[0])/1000),
                  (M2_s1_pre[i_contrast], (twindow[1]- twindow[0])/1000),
                  (M2_s1_post[i_contrast], (twindow[1]- twindow[0])/1000)]
    ...
    with open('Fig8_M2_Metrics.pkl', 'wb') as f:
