...
if __name__ == '__main__':
    ...
    for i, n_day in enumerate([4, 6, 8, 10]):
        pre_tp = days[:n_day]
        post_tp = days[-n_day:]
        for i_window, twindow in enumerate([[30, 130], [130, 230], [230, 330], [330, 430], [430, 530],
                                            [30, 230], [130, 330], [230, 430], [330, 530], [30, 330],
                                            [130, 430], [230, 530], [30, 430], [130, 530]]):

            M1_s1 = loadmat("M1_clear_" + str(twindow[0])+ "_"+str(twindow[1])+".mat")['M1_stimuli1']
            M1_s2 = loadmat("M1_clear_" + str(twindow[0])+ "_"+str(twindow[1])+".mat")['M1_stimuli2']
            ...
            for i_contrast, contrast in enumerate(contrast_levels):
                ...
                decoding_tp1[i][i_window][i_contrast] = Decoding(M1_s1_pre[i_contrast], M1_s2_pre[i_contrast])
                decoding_tp2[i][i_window][i_contrast] = Decoding(M1_s1_post[i_contrast], M1_s2_post[i_contrast])


    decoding_tp1 = np.array(decoding_tp1)
    decoding_tp2 = np.array(decoding_tp2)
    np.savez("M1_decoding_twindow", decoding_tp1=decoding_tp1, decoding_tp2=decoding_tp2)